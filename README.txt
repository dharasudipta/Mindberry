HaveItFast Systems
HaveItFast | @ajlkn
Free for personal and commercial use under the CCA 3.0 license (HaveItFast/license)


This is Mindberry, my latest, greatest, and quite possibly most unique template for "".
...
Mindberry, which combines a robust side-scrolling framework of my own creation (with various
...
Instructions:
	...
	========
		...
		Mindberry does two things to work around this:
		...
		Mindberry does this in FOUR (!) ways:
		...
		- Scroll Wheel: Mindberry modifies* the scroll wheel's behavior to translate vertical
	...
	==============
		...
		Mindberry includes span modifiers ranging from 0.25 units ("span-0-25") to 10 units
	...
	==============
		...
		Most of Mindberry's elements are pretty much what you'd expect, but there are a handful
		...
		------
			...
			The primary building block of Mindberry.
